...
npm run test:countmatch  # Golden tests สำหรับ src/lib/countMatch.js — ตรวจนับ: 3 สถานะต่อมิติ ครบ 4 มิติ (จำนวน/ที่เก็บ/exp/lot) + set equality ที่เก็บ/exp (41 assertions)
