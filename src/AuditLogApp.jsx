...
const ACTION_LABELS = {
  ...
  create_annual_count:          { label: 'เริ่มรอบตรวจนับประจำปี',   color: 'bg-indigo-100 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-300'},
  close_annual_count:           { label: 'ปิดรอบตรวจนับประจำปี',    color: 'bg-indigo-100 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-300'},
  add_annual_count_lot:         { label: 'เพิ่ม lot เข้ารอบประจำปี',  color: 'bg-indigo-100 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-300'},
  add_unknown_count_item:       { label: 'พบของนอกระบบตอนตรวจนับ', color: 'bg-amber-100 dark:bg-amber-950/60 text-amber-700 dark:text-amber-300'},
  create_temperature_log:       { label: 'บันทึกอุณหภูมิตู้เย็น',    color: 'bg-sky-100 dark:bg-sky-950/60 text-sky-700 dark:text-sky-300'},
  update_temperature_log:       { label: 'แก้ไขบันทึกอุณหภูมิ',      color: 'bg-sky-100 dark:bg-sky-950/60 text-sky-700 dark:text-sky-300'},
  ...
  refresh_annual_count_qty:     { label: 'รีเฟรชยอดระบบรอบนับ',     color: 'bg-sky-100 dark:bg-sky-950/60 text-sky-700 dark:text-sky-300'       },
...
export default function AuditLogApp({ onRefresh, auth, onGoBack, canGoBack }) {
  ...
  const ACTION_GROUPS = [
    ...
    { label: 'คลัง/Inventory', keys: ['import_inventory', 'create_stock_count', 'create_annual_count', 'close_annual_count', 'add_annual_count_lot', 'add_unknown_count_item', 'update_stock_count', 'clear_stock_count_item', 'refresh_annual_count_qty', 'followup_stock_count', 'delete_stock_count', 'seed_ledger', 'close_ledger_period', 'reopen_ledger_period', 'add_ledger_adjustment', 'create_temperature_log', 'update_temperature_log', 'delete_temperature_log', 'import_temperature_log'] },
