...
export default function AuditLogApp({ onRefresh, auth, onGoBack, canGoBack }) {
  ...
  const ACTION_GROUPS = [
    ...
    { label: 'คลัง/Inventory', keys: ['import_inventory', 'create_stock_count', 'update_stock_count', 'followup_stock_count', 'delete_stock_count', 'seed_ledger', 'close_ledger_period', 'reopen_ledger_period', 'add_ledger_adjustment'] },
