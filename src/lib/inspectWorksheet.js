...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  th { background: #fff; color: #000; font-weight: 700; padding: 5px 6px; text-align: center;
    border: 1px solid #000; }
  td { padding: 4px 8px; border: 1px solid #000; height: 36px; vertical-align: middle; }
  td.c { text-align: center; }
  .bx { display: inline-block; width: 13px; height: 13px; border: 1px solid #000; vertical-align: middle; }
